...
20.times do 
  User.create(name: Faker::FunnyName.name, age: rand(12...100), email: Faker::Internet.email)
end

60.times do 
  Order.create(user_id: User.all.sample.id, banana_id: Banana.all.sample.id)
end