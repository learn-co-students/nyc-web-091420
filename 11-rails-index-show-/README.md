...
- Use ActionView helpers like `link_to`, `button_to` and `form_for` `form_tag` to help write HTML
- BONUS: Use strong params to allow creating/updating models with mass assignment

App Idea
---

Frozen Banana Stand - 15
